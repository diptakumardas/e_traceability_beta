...
class TestPage2 extends StatefulWidget {
  const TestPage2({super.key, required this.selectedOptions});
              ...
              ElevatedButton(
                onPressed: () {
                  List<String> selectedOptions = _selectedIndices
                      ...
                      .toList();
                  selectedOptions.addAll(widget.selectedOptions); // Combine options from both pages
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => PreviewPage(selectedOptions: selectedOptions),
                    ),
                  );
                },
                child: Text("Submit"),
